...
void ClassLoader::print_counters() {
  if (UsePerfData) {
    ...
    if (log.is_enabled()) {
      ...
      log.print_cr("  clinit:               %ldms / %ld events; executed %ld bytecodes",
                   ClassLoader::class_init_time_ms(), ClassLoader::class_init_count(), ClassLoader::class_init_bytecodes_count());
